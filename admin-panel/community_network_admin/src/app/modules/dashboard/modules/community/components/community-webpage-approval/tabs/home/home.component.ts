...
@Component({
  selector: 'app-home-approval',
  templateUrl: './home.component.html',
  styleUrls: ['./home.component.scss']
})
export class CommunityApprovalHomeComponent implements OnInit {
  ...
  openDialog(index:number): void {
    const dialogRef = this.dialog.open(CommunityModalComponent, {
      height: '400px',
      width: '600px',
      data: {type:"Home", content: this.approvalList[index]},
    });
