...
@Component({
  selector: 'app-video-approval',
  templateUrl: './video.component.html',
  styleUrls: ['./video.component.scss']
})
export class CommunityApprovalVideoComponent implements OnInit {
  ...
  openDialog(index:number): void {
    const dialogRef = this.dialog.open(CommunityModalComponent, {
      height: '400px',
      width: '600px',
      data: {type:"Video", content: this.approvalList[index]},
    });
